(function() {
	...
	angular.module('WeViews').controller('MainBehaviorController', function MainBehaviorController($timeout,CommonSelectService,SwitchService,Message,$scope) {
        var vm = this;
        ...
        */
        vm.onOrgChange = function(){
            if(vm.curSetting.orgId){
                vm.isInit = false;
                var switchParam = {alarmFlag:"3",companyId:vm.curSetting.orgId};
