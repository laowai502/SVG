(function() {
	...
	angular.module('WeViews').controller('MainDmsController', MainDmsController);

	function MainDmsController($timeout,CommonSelectService,SwitchService,Message,$scope) {
        ...
        */
        vm.onOrgChange = function(){
            if(vm.curSetting.orgId){
                vm.isInit = false;
                var switchParam = {alarmFlag:"2",companyId:vm.curSetting.orgId};
