...
var carModelList = ['牵引车','自卸车','载货车']
var statusList = ['空载','半载','满载','超载']
...
var getCityByCode = function(cityCode) {
	var str = ''
	for (var i = 0, j = cityJson.length; i < j; i++) {
...
var getLoadTypeText = function(code) {
	var returnStr = '';
